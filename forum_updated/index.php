...
.text-editor-header .btn-custom {
    ...
    .table{
        background-color: white; 
        border: 5px solid rgba(127, 185, 182, 255);
    }
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="materialsDropdown">
                                <a class="dropdown-item" href="index.php">Основний форум</a>
                    ...
                    <?php
          // Перевірте, чи існує сесія Username
if(isset($_SESSION['username'])) {
    ...
    echo "
        <div id='myModal' class='disclaimer'>
...
<!-- Modal -->
<div id="ReplyModal" class="modal" role="dialog" style = "background-color: rgba(20, 162, 184, 255); ">
      ...
      <div class="modal-body">
        <form name="frm1" method="post">
            ...
            <div class="form-group text-info">
              <label for="usr">Введіть ваш нікнейм: </label>
              <input type="text" class="form-control" name="Rname" required>
            </div>
            <div class="form-group text-info">
              <label for="comment">Введіть свою відповідь:</label>
              <div class="main-content">
                <div class="text-editor-header">
                    <button type="button" class="btn-custom" data-element="bold">
                        <i class="fa fa-bold"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="italic">
                        <i class="fa fa-italic"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="underline">
                        <i class="fa fa-underline"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="insertUnorderedList">
                        <i class="fa fa-list-ul"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="insertOrderedList">
                        <i class="fa fa-list-ol"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="createLink">
                        <i class="fa fa-link"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="justifyLeft">
                        <i class="fa fa-align-left"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="justifyCenter">
                        <i class="fa fa-align-center"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="justifyRight">
                        <i class="fa fa-align-right"></i>
                    </button>

                    <button type="button" class="btn-custom" data-element="justifyFull">
                        <i class="fa fa-align-justify"></i>
                    </button>
                </div>
              </div>
              <div class="form-control" id="replyEditor" contenteditable="true" style="height:150px; border: 1px solid #ccc; padding: 10px;"></div>
              <input type="hidden" name="Rmsg" id="hiddenReplyMsg">
            </div>
            <input type="button" id="btnreply" name="btnreply" class="btn" value="Відповісти" onclick="submitReplyForm()">
        </form>
      </div>
    </div>
...
<div class="panel panel-default" style="margin-top:50px;">
  <div class="panel-body text-white">
    ...
    <form name="frm" method="post">
        ...
        <div class="form-group text-white">
          <label for="topic">Введіть тему розмови:</label>
          <input type="text" class="form-control" name="topic" required>
        </div>
        <div class="form-group text-white">
          <label for="comment">Задайте своє питання:</label>
          <div class="main-content">
            <div class="text-editor-header">
                <button type="button" class="btn-custom" data-element="bold">
                    <i class="fa fa-bold"></i>
          ...
          <div class="form-control" id="editor" contenteditable="true" style="height:250px; border: 1px solid #ccc; padding: 10px;"></div>
          <input type="hidden" name="msg" id="hiddenMsg">
        </div>
        <input type="button" id="butsave" name="save" class="btn" value="Надіслати" onclick="submitForm()">
    </form>
  </div>
</div>
...
const hiddenReplyMsg = document.getElementById('hiddenReplyMsg');

elements.forEach(element => {
    element.addEventListener('click', () => {
        let command = element.dataset['element'];
        if (command === 'createLink') {
            let url = prompt("Введіть своє посилання: ", "http://");
...
function submitForm() {
    hiddenMsg.value = editor.innerHTML;
    document.forms['frm'].submit();
}

function submitReplyForm() {
    hiddenReplyMsg.value = replyEditor.innerHTML;
