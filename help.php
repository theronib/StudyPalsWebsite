...
<style>
 main {
    ...
    h2:not(.h4), h3  {
        ...
        color: rgb(164, 239, 248);
        overflow: hidden;
        animation: typewriter 2s steps(44) 1s 1 normal both, blinkTextCursor 500ms infinite;
        white-space: nowrap;
    }
            ...
            <div class="container">
                <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                    <div class="col-12 col-lg-6 col-xl-5">
                        <img class="img-fluid rounded" loading="lazy" src="boy.png" alt="Help">
                    </div>
                    <div class="col-12 col-lg-6 col-xl-7">
                        <div class="row justify-content-xl-center">
                            <div class="col-12 col-xl-11">
                                <h2 class="mb-3" id = "help">Допомога</h2>
                                <p class="lead fs-4 text-white mb-3">StudyPals - Платформа для підготовки до НМТ. Це
                                    чудове місце для вивчення і повторення шкільного матеріалу.
                                </p>
                                <p class="mb-5">Сайт має досить зручний інтерфейс, який є зрозумілим для користувачів. На головній сторінці можна побачити вкладки «Матеріали, Медіа, Форум, Чат, Додаткові уроки, Магазин».
                                Також можна ознайомитися з описом і цілями команди. Справа зверху знаходяться кнопки «Логін, Реєстрація». А внизу сторінки – “Допомога, Про нас ”.</p>

                                <h3 class="mb-3">Функціональні можливості та опис розділів</h3>
                                <div class="row gy-4 gy-md-0 gx-xxl-5X">
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex">

                                            <div>
                                                <h2 class="h4 mb-3">1. Матеріали</h2>
                                                <p class="text-white mb-0">В цій вкладці можна побачити корисну інформацію з 9 предметів: <b> українська мова, математика, англійська мова, історія, українська література, біологія, географія, хімія та фізика.</b> Вся інформація розділена на теми, кожну з них користувач може переглянути, натиснувши на неї. Але якщо користувач не авторизований, то він не має доступу до проходження тестів.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">2. Медіа</h2>
                                                <p class="text-white mb-0">В цій вкладці можна побачити відеоуроки та аудіоуроки з 9 предметів: <b> українська мова, математика, англійська мова, історія, українська література, біологія, географія, хімія та фізика, </b> розділені на теми. І тільки зареєстрований користувач зможе переглянути їх.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h2 class="h4 mb-3">3. Форум</h2>
                                                <p class="text-white mb-0">В цій вкладці користувач зможе задати запитання та переглянути попередні. Але спочатку потрібно зареєструватися та описати тему подальшої розмови.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">4. Чат</h2>
                                                <p class="text-white mb-0">В цій вкладці користувачі можуть переписуватися між собою.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">5. Додаткові уроки</h2>
                                                <p class="text-white mb-0">В цій вкладці можна замовити індивідуальні уроки з викладачами. Все, що потрібно, це вибрати дату, час та предмет, який користувач хоче вивчати, а сама програма покаже, чи є вільні місця на обраний час. Після того, як користувач натисне кнопку “Забронювати”, з'явиться вікно з підтвердженням. Після підтвердження ми переходимо на вкладку з оплатою, і тільки після успішної оплати користувач отримає контактну інформацію.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">6. Магазин</h2>
                                                <p class="text-white mb-0">В цій вкладці користувач може придбати навчальний посібник з будь-якого предмету, також наявні книги для людей з обмеженими можливостями. Щоб купити книгу потрібно додати її в корзину і натиснути кнопку “Оплатити”. Сума покупки буде написана знизу.  Після цього користувач має ввести контактну інформацію та дані картки для оплати.</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            headers.forEach(header => {
                header.addEventListener('animationend', function (event) {
                    if (event.animationName === 'typewriter') {
                        header.classList.add('stop-blink');
                    }
                });
            });
        });
