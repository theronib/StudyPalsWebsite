        ...
        <section class="py-3 py-md-5">
            <div class="container">
                <section class="content">
                    <h1>Ми віримо у вас!</h1>
                    <p>Адаптовані посібники для підготовки до НМТ <br> в нашому онлайн-магазині.</p>
                    <div class="img" style="margin-left: 670px; position: absolute;">
                        <img src="kids_together.png" alt="item1"
                            style="max-width: 290px; max-height: 290px; margin-left: 30px;">
                    </div>
...
$book_query = "SELECT * FROM `DisabledBooks`";
...
while ($book_data = mysqli_fetch_assoc($book_result)) {
    ...
    $anotherimage = $book_data['anotherimg']; 
    ...
    <div class='sec'>
        <div class='row gx-4 gx-lg-5 align-items-center'>
            <div class='col-md-6'>
                ...
                <img class='detailed-img mb-5 mb-md-0' src='$anotherimage' alt='...' />
            </div>
            <div class='col-md-6'>
            <h4 id = 'id' style = 'display: none'>$id</h4>
                <div class='type small mb-1'>$type</div>
                <h3 class='name'>$name</h3>
                <div class='fs-5 mb-5'>
                    <span class='price'>" . number_format($price, 0, '.', ' ') . " грн.</span>
                </div>
...
<script>
        ...
        let products = [
            {
                id: 1,
                type: 'Українська мова',
                name: 'Універсальний довідник (для сліпих шрифтом Брайля)',
                description: "Цей універсальний довідник з української мови призначений для учнів закладів загальної середньої освіти, абітурієнтів, студентів та всіх, хто прагне поглибити свої знання з мови. Книга побудована відповідно до чинної навчальної програми з української мови та відповідає вимогам НМТ. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book1_special.JPG',
                image_detailed: 'ukr_special_open.png',
                price: 87
            },
            {
                id: 2,
                type: 'Математика',
                name: 'Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з математики розроблений спеціально для абітурієнтів та школярів, які готуються до вступних іспитів та НМТ. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book3_special.JPG',
                image_detailed: 'math_special_open.png',
                price: 95
            },
            {
                id: 3,
                type: 'Історія України',
                name: 'Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з історії України розроблений спеціально для абітурієнтів та школярів, які готуються до вступних іспитів та НМТ. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book4_special.JPG',
                image_detailed: 'history_special_open.png',
                price: 110
            },
            {
                id: 4,
                type: 'Українська література',
                name: 'Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з української літератури створений для учнів закладів загальної середньої освіти та абітурієнтів, які готуються до вступних іспитів та НМТ. Посібник охоплює ключові теми та твори української літератури, які входять до навчальної програми. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book2_special.JPG',
                image_detailed: 'literature_special_open.png',
                price: 74
            },
            {
                id: 5,
                type: 'Біологія',
                name: 'Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з біології розроблений для учнів закладів загальної середньої освіти та абітурієнтів, які готуються до вступних іспитів та НМТ. Посібник охоплює основні розділи біології, необхідні для успішного складання іспитів. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book5_special.JPG',
                image_detailed: 'biology_special_open.png',
                price: 50
            },
            {
                id: 6,
                type: 'Фізика',
                name: 'Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з фізики призначений для учнів закладів загальної середньої освіти та абітурієнтів, які готуються до вступних іспитів та НМТ. Посібник охоплює основні розділи фізики, необхідні для глибокого розуміння предмету та успішного складання іспитів. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book6_special.JPG',
                image_detailed: 'physics_special_open.png',
                price: 60
            },
            {
                id: 7,
                type: 'Хімія',
                name: 'Хімія. Довідник для абітурієнтів та школярів (для сліпих шрифтом Брайля)',
                description: "Цей довідник з хімії призначений для учнів закладів загальної середньої освіти та абітурієнтів, які готуються до вступних іспитів та НМТ. <br> <u> Посібник також адаптовано для сліпих та слабозорих людей. Він доступний у форматі Брайля, що дозволяє людям з вадами зору повноцінно користуватися матеріалами для підготовки.</u>",
                image: 'book7_special.JPG',
                image_detailed: 'chemistry_special_open.png',
                price: 80
            }
        ];
...
function redirectToPayment(event) {
    ...
    let cartDetails = listCards.map(item => {
        return `${item.id}. ${item.name} (${item.type}): ${item.price} грн x ${item.quantity}`;
    }).join("<br>");
    ...
    confirmButton.onclick = function() {
        ...
        let paymentURL = `paymentdisabled.php?ids=${ids}&prices=${prices}&totalPrice=${totalPrice}`;
