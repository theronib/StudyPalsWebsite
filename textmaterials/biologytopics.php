...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з біології</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Біологія:</h1>
        <div>
            <h5 onclick="location.href='../tests/biologytests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='biology/bi_topic1.html';">Тема 1. Еволюція</li>
                <li class="list-group-item" onclick="location.href='biology/bi_topic2.html';">Тема 2. Екологія. Екологічні взаємодії</li>
                <li class="list-group-item" onclick="location.href='biology/bi_topic3.html';">Тема 3. Клітина. Клітинна біологія</li>
                <li class="list-group-item" onclick="location.href='biology/bi_topic4.html';">Тема 4. Геноміка та генетична інженерія</li>
                <li class="list-group-item" onclick="location.href='biology/bi_topic5.html';">Тема 5. Екосистема</li>
                <li class="list-group-item">Тема 6. Біорізноманіття</li>
                <li class="list-group-item">Тема 7. Віруси, бактерії, археї</li>
                <li class="list-group-item">Тема 8. Рослини та тварини</li>
                <li class="list-group-item">Тема 9. Охорона біорізноманіття</li>
                <li class="list-group-item">Тема 10. Організм людини як біологічна система</li>
                <li class="list-group-item">Тема 11. Розмноження та розвиток людини</li>
                <li class="list-group-item">Тема 12. Здоров'я людини</li>
                <li class="list-group-item">Тема 13. Охорона природи</li>
            </ul>
        </section>
    </main>
