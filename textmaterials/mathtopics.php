...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з математики</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Математика:</h1>
        <div>
          
            <h5 onclick="location.href='../tests/mathtests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='math/ma_topic1.html';">Тема 1. Рівняння на нерівності</li>
                <li class="list-group-item" onclick="location.href='math/ma_topic2.html';">Тема 2. Теорія чисел: НСД та НСК</li>
                <li class="list-group-item" onclick="location.href='math/ma_topic3.html';">Тема 3. Евклідова геометрія</li>
                <li class="list-group-item" onclick="location.href='math/ma_topic4.html';">Тема 4. Вектори. Тригонометричні функції</li>
                <li class="list-group-item" onclick="location.href='math/ma_topic5.html';">Тема 5. Теорія ймовірності</li>
                <li class="list-group-item">Тема 6. Відсотки. Відношення та пропорції</li>
                <li class="list-group-item">Тема 7. Функціональна залежність</li>
                <li class="list-group-item">Тема 8. Екстремуми функції</li>
                <li class="list-group-item">Тема 9. Похідна функції</li>
                <li class="list-group-item">Тема 10. Первісна та визначений інтеграл</li>
                <li class="list-group-item">Тема 11. Правила знаходження первісних</li>
                <li class="list-group-item">Тема 10. Перестановки, комбінації, розміщення</li>
                <li class="list-group-item">Тема 11. Комбінаторні правила</li>
                <li class="list-group-item">Тема 12. Означення вибіркових характеристик</li>
                <li class="list-group-item">Тема 13. Графіки</li>
                <li class="list-group-item">Тема 14. Табличні форми подання статистичних даних</li>
                <li class="list-group-item">Тема 15. Текстові форми подання статистичних даних</li>
                <li class="list-group-item">Тема 16. Інтерпретація діаграм та гістограм</li>
            </ul>
        </section>
    </main>
