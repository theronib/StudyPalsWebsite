...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з географії</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Географія:</h1>
        <div>
           
            <h5 onclick="location.href='../tests/geographytests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='geography/geo_topic1.html';">Тема 1. Фізична географія</li>
                <li class="list-group-item" onclick="location.href='geography/geo_topic2.html';">Тема 2. Економічна географія</li>
                <li class="list-group-item" onclick="location.href='geography/geo_topic3.html';">Тема 3. Фізико-географічні умови та ресурси</li>
                <li class="list-group-item" onclick="location.href='geography/geo_topic4.html';">Тема 4. Регіональна географія</li>
                <li class="list-group-item" onclick="location.href='geography/geo_topic5.html';">Тема 5. Геоекологія та екологічна політика</li>
                <li class="list-group-item">Тема 6. Географія материків і океанів</li>
                <li class="list-group-item">Тема 7. Населення України та світу</li>
                <li class="list-group-item">Тема 8. Регіони світу</li>
                <li class="list-group-item">Тема 9. Країни світу</li>
                <li class="list-group-item">Тема 10. Глобальні проблеми людства</li>
                <li class="list-group-item">Тема 11. Сталий розвиток</li>
                <li class="list-group-item">Тема 12. Роль світової громадськості</li>
                <li class="list-group-item">Тема 13. Міжнародні організації</li>
                <li class="list-group-item">Тема 14. Стратегія людства на 21 століття</li>
                <li class="list-group-item">Тема 15. Шляхи подолання проблем</li>
            </ul>
        </section>
    </main>
