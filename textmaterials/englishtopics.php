...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з англійської мови</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Англійська мова:</h1>
        <div>
            
            <h5 onclick="location.href='../tests/englishtests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='english/en_topic1.html';">Тема 1. Present Simple</li>
                <li class="list-group-item" onclick="location.href='english/en_topic2.html';">Тема 2. Present Continuous</li>
                <li class="list-group-item" onclick="location.href='english/en_topic3.html';">Тема 3. Present Perfect</li>
                <li class="list-group-item" onclick="location.href='english/en_topic4.html';">Тема 4. Past Simple</li>
                <li class="list-group-item" onclick="location.href='english/en_topic5.html';">Тема 5. Past Continuous</li>
                <li class="list-group-item">Тема 6. Past Perfect</li>
                <li class="list-group-item">Тема 7. Future Simple</li>
                <li class="list-group-item">Тема 8. Future Continuous</li>
                <li class="list-group-item">Тема 9. Past Perfect Continuous</li>
                <li class="list-group-item">Тема 10. Present Perfect Continuous</li>
                <li class="list-group-item">Тема 11. Future Perfect Continuous</li>
            </ul>
        </section>
    </main>
