...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з хімії</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Хімія:</h1>
        <div>
           
            <h5 onclick="location.href='../tests/chemistrytests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='chemistry/ch_topic1.html';">Тема 1. Хімічні речовини</li>
                <li class="list-group-item" onclick="location.href='chemistry/ch_topic2.html';">Тема 2. Валентність та молярна маса. Періодична система</li>
                <li class="list-group-item" onclick="location.href='chemistry/ch_topic3.html';">Тема 3. Хімічні зв'язки</li>
                <li class="list-group-item" onclick="location.href='chemistry/ch_topic4.html';">Тема 4. Хімічні реакції. Закон збереження маси</li>
                <li class="list-group-item" onclick="location.href='chemistry/ch_topic5.html';">Тема 5. Органічна хімія</li>
                <li class="list-group-item">Тема 6. Вуглеводні</li>
                <li class="list-group-item">Тема 7. Природні джерела вуглеводнів</li>
                <li class="list-group-item">Тема 8. Жири та вуглеводи</li>
                <li class="list-group-item">Тема 9. Аміни та амінокислоти</li>
                <li class="list-group-item">Тема 10. Білки. Нуклеїнові кислоти</li>
                <li class="list-group-item">Тема 11. Полімери. Полімерні метали</li>
                <li class="list-group-item">Тема 12. Застосування органічних сполук</li>
            </ul>
        </section>
    </main>
