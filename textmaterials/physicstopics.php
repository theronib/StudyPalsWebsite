...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з фізики</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Фізика:</h1>
        <div>
           
            <h5 onclick="location.href='../tests/physicstests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='physics/ph_topic1.html';">Тема 1. Механіка</li>
                <li class="list-group-item" onclick="location.href='physics/ph_topic2.html';">Тема 2. Термодинаміка</li>
                <li class="list-group-item" onclick="location.href='physics/ph_topic3.html';">Тема 3. Електрика</li>
                <li class="list-group-item" onclick="location.href='physics/ph_topic4.html';">Тема 4. Світло та його фізичні властивості</li>
                <li class="list-group-item" onclick="location.href='physics/ph_topic5.html';">Тема 5. Радіо фізика. Астрофізика</li>
                <li class="list-group-item">Тема 6. Молекулярна фізика</li>
                <li class="list-group-item">Тема 7. Коливання і хвилі</li>
                <li class="list-group-item">Тема 8. Елементи теорії відносності</li>
                <li class="list-group-item">Тема 9. Квантова фізика</li>
                <li class="list-group-item">Тема 10. Термоядерна фізика</li>
            </ul>
        </section>
    </main>
