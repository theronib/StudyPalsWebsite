...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з української мови</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Українська мова:</h1>
        <div>
            
            <h5 onclick="location.href='../tests/ukrtests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='ukrainian/ukr_topic1.html';">Тема 1. Фонетика, графіка, орфоепія</li>
                <li class="list-group-item" onclick="location.href='ukrainian/ukr_topic2.html';">Тема 2. Словотворення. Іменник</li>
                <li class="list-group-item" onclick="location.href='ukrainian/ukr_topic3.html';">Тема 3. Іменник як частина мови</li>
                <li class="list-group-item" onclick="location.href='ukrainian/ukr_topic4.html';">Тема 4. Іменник - самостійна частина мови</li>
                <li class="list-group-item" onclick="location.href='ukrainian/ukr_topic5.html';">Тема 5. Прикметник як частина мови</li>
                <li class="list-group-item">Тема 6. Числівник</li>
                <li class="list-group-item">Тема 7. Займенник</li>
                <li class="list-group-item">Тема 8. Дієслово</li>
                <li class="list-group-item">Тема 9. Дієприкметник</li>
                <li class="list-group-item">Тема 11. Дієпристівник</li>
                <li class="list-group-item">Тема 12. Пристівник та прийменник</li>
                <li class="list-group-item">Тема 13. Сполучник та частка</li>
                <li class="list-group-item">Тема 14. Класифікація речень</li>
                <li class="list-group-item">Тема 15. Головні та другорядні члени речення</li>
                <li class="list-group-item">Тема 16. Односкладні речення</li>
                <li class="list-group-item">Тема 17. Складне речення</li>
                <li class="list-group-item">Тема 18. Відокремлені члени речення</li>
                <li class="list-group-item">Тема 19. Чуже мовлення</li>
                <li class="list-group-item">Тема 20. Засоби міжфразової єдності</li>
                <li class="list-group-item">Тема 21. Стилістика. Текст</li>
                <li class="list-group-item">Тема 22. Розвиток мовлення</li>
            </ul>
        </section>
    </main>
