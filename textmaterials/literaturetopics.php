...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Довідкові матеріали до НМТ з української літератури</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Українська література:</h1>
        <div>
          
            <h5 onclick="location.href='../tests/literaturetests.php';">Тести</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='literature/lit_topic1.html';">Тема 1. Класична література</li>
                <li class="list-group-item" onclick="location.href='literature/lit_topic2.html';">Тема 2. Творчість Івана Франка та Лесі Українки</li>
                <li class="list-group-item" onclick="location.href='literature/lit_topic3.html';">Тема 3. Сучасна література</li>
                <li class="list-group-item" onclick="location.href='literature/lit_topic4.html';">Тема 4. Поетична спадщина України</li>
                <li class="list-group-item" onclick="location.href='literature/lit_topic5.html';">Тема 5. Проза та драматургія</li>
                <li class="list-group-item">Тема 6. Історичні пісні</li>
                <li class="list-group-item">Тема 7. Григорій Сковорода</li>
                <li class="list-group-item">Тема 8. Микола Хвильовий </li>
                <li class="list-group-item">Тема 9. Володимир Сосюра </li>
                <li class="list-group-item">Тема 10. Твори українських письменників-емігрантів</li>
                <li class="list-group-item">Тема 11. Список літератири на НМТ</li>
            </ul>
        </section>
    </main>
