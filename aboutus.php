            ...
            <div class="container">
                <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                    <div class="col-12 col-lg-6 col-xl-5">
                        <img class="img-fluid rounded" loading="lazy" src="computer.png" alt="About 1">
                    </div>
                    <div class="col-12 col-lg-6 col-xl-7">
                        <div class="row justify-content-xl-center">
                            <div class="col-12 col-xl-11">
                                <h2 class="mb-3">Хто ми?</h2>
                                ...
                                <p class="mb-5">Ми - команда ентузіастів, що об’єднали свої зусилля, аби створити
                                    інноваційний та зручний інструмент для учнів, які готуються до Національного
                                    мультипредметного тесту. Наша мета - допомогти кожному учню досягти високих
                                    результатів та відчувати себе впевнено під час складання іспиту.</p>

                                <h3 class="mb-3">Цілі, які ми переслідуємо:</h3>
                                <div class="row gy-4 gy-md-0 gx-xxl-5X">
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex">

                                            <div>
                                                <h2 class="h4 mb-3">Підвищення рівня освіти</h2>
                                                <p class="text-white mb-0">Ми прагнемо забезпечити учнів якісними
                                                    навчальними матеріалами, що відповідають найвищим освітнім
                                                    стандартам.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">Доступність освіти</h2>
                                                <p class="text-white mb-0">Створити платформу, яка буде доступною
                                                    для всіх, включаючи учнів з обмеженими можливостями.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h2 class="h4 mb-3">Інтерактивне навчання</h2>
                                                <p class="text-white mb-0">Забезпечити інтерактивні методи навчання, які
                                                    зроблять процес підготовки цікавим та ефективним.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mt-5">
                                        <div class="d-flex">
                                            <div>
                                                <h2 class="h4 mb-3">Орієнтація на результат</h2>
                                                <p class="text-white mb-0">Допомагати учням досягати високих результатів
                                                    на НМТ завдяки структурованій та систематичній підготовці.</p>
                                            </div>
                                        </div>
                                    </div>
