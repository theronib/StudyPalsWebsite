...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з української літератури</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з української літератури:</h1>
        <div>
            
                <h5 onclick="location.href='../textmaterials/literaturetopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" onclick="location.href='Test/literature/test1/test.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/literature/test2/test.html';">Тест 2</li>
                <li class="list-group-item">Тест 3</li>
            </ul>
        </section>
    </main>
