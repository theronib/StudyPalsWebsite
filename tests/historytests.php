...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з історії України</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з історії України:</h1>
        <div>
            
                <h5 onclick="location.href='../textmaterials/historytopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true" onclick="location.href='Test/history/test1/test.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/history/test2/test2.html';">Тест 2</li>
                <li class="list-group-item" onclick="location.href='Test/history/test3/test3.html';">Тест 3</li>
            </ul>
        </section>
    </main>
