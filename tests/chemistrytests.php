...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з хімії</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з хімії:</h1>
        <div>
           
                <h5 onclick="location.href='../textmaterials/chemistrytopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true" onclick="location.href='Test/chemistry/test1/testChemistry1.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/chemistry/test2/testChemistry2.html';">Тест 2</li>
                <li class="list-group-item" onclick="location.href='Test/chemistry/test3/testChemistry3.html';">Тест 3</li>
            </ul>
        </section>
    </main>
