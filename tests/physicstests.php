...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з фізики</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з фізики:</h1>
        <div>
            
                <h5 onclick="location.href='../textmaterials/physicstopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true" onclick="location.href='Test/physics/test1/testPhysics1copy.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/physics/test2/testPhysics2.html';">Тест 2</li>
                <li class="list-group-item" onclick="location.href='Test/physics/test3/testPhysics3.html';">Тест 3</li>
            </ul>
        </section>
    </main>
