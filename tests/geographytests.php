...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з географії</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з географії:</h1>
        <div>
         
                <h5 onclick="location.href='../textmaterials/geographytopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true">Тест 1</li>
                <li class="list-group-item">Тест 2</li>
