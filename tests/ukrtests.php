...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з української мови</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з української мови:</h1>
        <div>
            
                <h5 onclick="location.href='../textmaterials/ukrtopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true" onclick="location.href='Test/ukrainian/test1/test.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/ukrainian/test2/test2.html';">Тест 2</li>
                <li class="list-group-item" onclick="location.href='Test/ukrainian/test3/test3.html';">Тест 3</li>
            </ul>
        </section>
    </main>
