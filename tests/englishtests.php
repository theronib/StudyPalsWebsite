...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з англійської мови</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з англійської мови:</h1>
        <div>
           
                <h5 onclick="location.href='../textmaterials/englishtopics.php';">Повернутися до матеріалів</h5>
        </div>

        <section class="sec">
            <ul class="list-group">
                <li class="list-group-item" aria-current="true" onclick="location.href='Test/english/test1/testEnglish1.html';">Тест 1</li>
                <li class="list-group-item" onclick="location.href='Test/english/test2/testEnglish2.html';">Тест 2</li>
                <li class="list-group-item" onclick="location.href='Test/english/test3/testEnglish3.html';">Тест 3</li>
            </ul>
        </section>
    </main>
