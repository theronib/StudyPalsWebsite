...
<head>
    <meta charset="UTF-8" />
    <title>StudyPals - Тести з математики</title>
...
?>
    ...
    <main>
        <h1 class="pheading">Тести з математики:</h1>
        <div>
            
                <h5 onclick="location.href='../textmaterials/mathtopics.php';">Повернутися до матеріалів</h5>
        </div>
